...
export const SAMPLE_TRIALS: Trial[] = [
  {
    ...
    tagline: "A one-time treatment that could end a disease affecting eight million people worldwide.",
  ...
  },
  {
    ...
    tagline: "The first drug shown to slow cognitive decline in early Alzheimer's — a field that had seen decades of failures.",
  ...
  },
  {
    ...
    tagline: "Reprograms a patient's own immune cells to hunt cancer — moved earlier in treatment, it could spare thousands from grueling transplants.",
  ...
  },
  {
    ...
    tagline: "Tests whether a weight-loss drug can also prevent heart attacks — potentially redefining how the world treats cardiovascular risk.",
  ...
  },
  {
    ...
    tagline: "Brings the mRNA platform behind the COVID vaccines to one of history's deadliest infections.",
